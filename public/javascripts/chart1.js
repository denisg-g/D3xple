...
d3.csv("/CursosComputacion2015-2018.csv", function(d) {
  d.date = parseDate(d.ALCodigo);
  d.value = +d.value;
  return d;
}, function(error, data) {
...
d3.csv("/CursosComputacion2015-2018.csv", function(d) {
    var start = new Date("2015/01/10");
    var end = new Date("2018/12/12");
    var diff = new Date(start.getTime() + Math.random() * (end.getTime() - start.getTime()));  
